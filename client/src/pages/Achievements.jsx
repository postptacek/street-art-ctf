...
import { ACHIEVEMENTS, ACHIEVEMENT_CATEGORIES, RARITY_CONFIG, getAchievementHue, checkAchievements } from '../data/achievements'
                            ...
                            >
                                ...
                                <div className="w-16 h-16 mb-2 relative flex items-center justify-center">
                                    <img
                                        ...
                                        style={{
                                            filter: isUnlocked
                                                ? `hue-rotate(${getAchievementHue(achievement)}) saturate(1.3)`
                        ...
                        >
                            ...
                            <div className="w-28 h-28 mx-auto mb-4">
                                <img
                                    ...
                                    className="w-full h-full object-contain"
                                    style={{
                                        filter: `hue-rotate(${getAchievementHue(selectedAchievement)}) saturate(1.3)`
                                    }}
                                />
                            </div>
